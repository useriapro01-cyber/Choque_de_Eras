...
function renderVincular(){
  ...
  const form=v.passo==="dados"?
    `<label for="vEmail" class="eyebrow">${t("vinc_email_label")}</label>
     <input id="vEmail" type="email" inputmode="email" autocomplete="email" maxlength="254" placeholder="${t("vinc_email_ph")}" value="${esc(v.email||"")}" oninput="avisoLimite(this,'vEmailAviso',254,'vinc_email_longo')">
     <p id="vEmailAviso" class="muted aviso-limite"></p>
     <label for="vApelido" class="eyebrow">${t("vinc_apelido_label")}</label>
